 ...
 */
+ (void)getAvailableIPWithAppDeviceID:(NSString *)appDeviceID ClientID:(NSString *)clientID userAge:(long)userAge ipCount:(int)ipCount completion:(void(^)(id data))completion;
